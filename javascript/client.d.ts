...
declare module 'laserstream-core-proto-js/generated' {
  namespace geyser {
    ...
    interface ISubscribeRequestFilterAccounts {
      /**
       * Which write-locked accounts to deliver (proto field #31). Defaults to
       * `'write'` (also when omitted): only accounts a transaction actually
       * mutated, dropping write-locked-but-unchanged ones. `'lock'` opts back
       * into delivering every write-locked account. Removed once a
